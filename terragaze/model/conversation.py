...
#| copied from llamafactory, see https://github.com/hiyouga/LlamaFactory/blob/main/src/llamafactory/data/template.py
...
# )
#| This template is definitely used by qwen3!
register_conv_template(
    Conversation(
        name='internvl2_5',
        system_template='<|im_start|>system\n{system_message}',
...
TEOCHAT_SHARED_SYSTEM_MESSAGE = (
    "A chat between a curious human and an artificial intelligence assistant. "
    "The assistant gives helpful, detailed, and polite answers to the human's questions."
)
conv_templates["internvl2_5"].system_message = TEOCHAT_SHARED_SYSTEM_MESSAGE
conv_templates["TinyLlama"].system_message = TEOCHAT_SHARED_SYSTEM_MESSAGE
